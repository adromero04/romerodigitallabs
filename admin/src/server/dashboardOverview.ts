...
import { getRecentUsers as simpleListRecent, getUserSignupTrend as simpleListUserSignupTrend } from "@/lib/supabase/simplelist-admin";
...
/** Sum of per-app trends for the combined overview card (both must be loaded). */
